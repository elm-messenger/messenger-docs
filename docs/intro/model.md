...
- `envro` is the _read-only environment type_. In Messenger-specific aliases this is `Runtime`.

- `env` is the writable _environment type_. In Messenger it contains _global data_ and _common data_, if any.
